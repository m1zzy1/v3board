            ...
            <tr>
                <td>
                    ...
                    <div style="padding: 40px; color: #c2c9d6;">
                        <h2 style="margin: 0 0 20px; font-size: 24px; color: #ffffff; text-align: center;">⚠️ 到期通知</h2>
                        ...
                        <div style="margin-top: 30px; text-align: center;">
                            <a href="{{$url}}" style="display: inline-block; padding: 14px 36px; background: linear-gradient(135deg, #ff7272 0%, #ff3c3c 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: 500; transition: all 0.2s; box-shadow: 0 4px 20px rgba(255, 114, 114, 0.4);">
                                💳 立即续费
                            </a>
                        </div>
                    </div>
